...
<footer className="bg-slate-800 dark:bg-gray-900 mt-5 mb-2">
    ...
    <div className="px-4 py-6 bg-gray-100 bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-white text-gray-300 sm:text-center">© {year} <a href="#">JustShop™</a>. All Rights Reserved.
        </span>
